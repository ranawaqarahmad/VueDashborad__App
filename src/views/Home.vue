            ...
            <v-flex>
              <v-card class="ma-5 text-center mt-8" shaped elevation="10">
                ...
                <v-list-item class="mt-n5">
                  <v-list-item-subtitle>+O</v-list-item-subtitle>
                  <v-list-item-subtitle>177 cm</v-list-item-subtitle>
              ...
              <v-card class="ma-5 mt-n2" shaped elevation="10">
                <v-list>
                  <v-list-item>
                    ...
                    <v-list-item-subtitle class="ml-n2">10 mg</v-list-item-subtitle>
                  </v-list-item>
                  <v-list-item>
                ...
                <v-list two-line="" subheader="">
                  <v-list-item>
                      ...
                      <v-list-item-content class="ml-n2">
                        <v-list-item-title>Dr. Isebella Bowers</v-list-item-title>
                ...
                <v-list two-line="" subheader="" class="my-n8">
                    ...
                    <v-list-item class="mt-n10">
                      <v-list-item-title>18 Dec 2020</v-list-item-title>  
                      <v-list-item-title>11 11 PM</v-list-item-title>  
                    </v-list-item> 
                </v-list>
              </v-card>
            </v-flex>
              ...
              <v-card class="ma-5 text-center mt-12" shaped=" " elevation="10">
                  <v-list-item three-line>
                    <v-list-item-content>
                      ...
                      <v-list-item-subtitle>245 8563 5486 6321</v-list-item-subtitle>
                    </v-list-item-content>
       ...
       <v-app :style="{background: $vuetify.theme.themes.dark.background}" class="rounded">
         <v-container>
           <v-flex>
             <v-list class="mt-5">
               <v-list-item>
                 <v-list-item-title class="cyan--text text--darken-1">Examination</v-list-item-title>
                 <v-list-item-action>
                   <v-btn class="ma-2" tiled outlined="" color="cyan darken-1">
                 ...
                 <v-row>
                   ...
                   <v-col cols="12" md="10">
                     <v-list two-line="" subheader="" class="ml-n8">
                       <v-list-item>
                         <v-list-item-content>
                           <v-list-item-subtitle>18 Dec, 2020</v-list-item-subtitle>
                   ...
                   <v-col cols="12" md="10">
                     <v-list two-line="" subheader="" class="ml-n8">
                       <v-list-item>
                         <v-list-item-content>
                           <v-list-item-subtitle>18 Dec, 2020</v-list-item-subtitle>
                           <v-list-item-title>Osteoprosis</v-list-item-title>
                 ...
                 <v-flex>
                   <v-list class="mt-5">
                      <v-list-item>
                        ...
                        <v-item-content>
                          <v-btn class="mr-1" outlined color="cyan darken-1">Y</v-btn>
                        </v-item-content>
                      </v-list-item>   
                   </v-list>
                 </v-flex>
